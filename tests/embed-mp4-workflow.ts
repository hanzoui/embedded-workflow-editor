  ...
  try {
    ...
    if (extractedMetadata.workflow) {
      ...
      const extractedJson = JSON.stringify(
        JSON.parse(extractedMetadata.workflow),
      );
      ...
      console.log(
        "Workflow preview:",
        extractedMetadata.workflow.substring(0, 100) + "...",
      );
    }
  } catch (error) {
